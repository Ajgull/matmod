...
\begin{equation}
	\begin{cases}
		M_2 \dfrac{d^2 \vec{v}_2}{dt^2} = -G M_1 M_2 \dfrac{\vec{r}_{12}}{|\vec{r}_{12}|^3} + G M_2 M_3 \dfrac{\vec{r}_23}{|\vec{r}_{23}|^3}, \\[12pt]
...
\end{equation}
	...
	\begin{equation}
		m(t) = 
		\begin{cases}
			\dfrac{M_{0} + M_{\text{т}}}{1-0{,}025} - \dfrac{M_{\text{т}}t}{T}, & t < T, \\[1em]
			M_{0}, & t \geq T.
		\end{cases}
		\label{eq:mass_time}\nonumber
	\end{equation}
	...
	\[
	\begin{cases}
		x|_{t=0} = R_1 + (R_{12} + H) \cdot \cos(\alpha), \\
		y|_{t=0} = 0, \\
		v_x|_{t=0} = 0, \\
		v_y|_{t=0} = V_2 + V_{1\text{к}},\nonumber
	\end{cases}
	\]
